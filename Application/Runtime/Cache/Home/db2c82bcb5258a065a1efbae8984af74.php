...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        ...
        <p class="weui-msg__desc">请您等待医院方确认预约<br>您也可以在<a href="/Home/Index/MyAppointment">查看预约</a>里联系医院</p>
    </div>
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="/Home/Index/MyAppointment" class="weui-btn weui-btn_primary">查看预约</a>
            <a href="/Home/Index/PersonCenter" class="weui-btn weui-btn_default">返<i style="color: transparent;">返回</i>回</a>
        </p>
    </div>
    <div class="weui-msg__extra-area">
        <div class="weui-footer">
            <p class="weui-footer__links">
                <a href="/Home/Index/AppointmentNotice" class="weui-footer__link">预约须知</a>
            </p>
        </div>
    </div>
</div>
